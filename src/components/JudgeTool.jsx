...
const createBoard = () => ({
  version: 2,
  camps: { divine: Array(3).fill(null).map(() => ({ role: '', number: '' })), wolves: Array(3).fill(null).map(() => ({ role: '', number: '' })), villagers: Array(2).fill(null).map(() => ({ role: '', number: '' })), third: [{ role: '', number: '' }] },
